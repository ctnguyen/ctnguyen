...
\psgrid[subgriddiv=1,gridcolor=gray,griddots=10](-5,-3)(-1,1)               % set grid for Swaptions matrix
...
\psgrid[subgriddiv=1,gridcolor=gray,griddots=10,subgriddiv=2,subgriddots=5](2,-3)(6,1)          % set grid for vol matrix
...
\psset{linecolor=blue} % set points for swaption matrix
