...
//										   double T);
//{
//... shit to clear it latter. ... 
//	//-- !! variable _1 represents the SQUARED volatility 
//	boost::function<double(double)> f = boost::bind(&NumericalMethods::BlackFormula,this,fwd,strike,_1,discount);
//	boost::function<double(double)> f_derivative = boost::bind(call_BS_vega,_1,fwd,strike,);
//	
...
//	return sqrt(result_newton_raphson);
//
//}
