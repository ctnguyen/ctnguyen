...
struct PageTrait
{
    const size_t PAGE_SIZE = 1000000;// 1M
    typedef double OBJ_TYPELIST;
    // add more config here, this is a concept
};

 // contain serializable objects in the page
//
template<typename PageTrait>
struct VirtualPage
{
    const size_t PAGE_SIZE = 1000000;// 1M
    // add more config here, this is a concept
