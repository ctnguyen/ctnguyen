...
## Include guard
if(InvestigateTargetProperties_Include)
  return()
endif()
set(InvestigateTargetProperties_Include TRUE)

### Function to investigate all target properties
###
### TODO get full list of PROPERTY for all type of  target
...
function(echo_target_property tgt prop)
    ...
    if(s OR d)
        ...
        message("             - ERROR PROPERTY [${prop}] is not SET or DEFINED for TARGET [${tgt}]")
    endif()
endfunction()
 
function(echo_target tgt)
    message(" ============ Investigate properties for TARGET[${tgt}] ============ ")
    if(NOT TARGET ${tgt})
        message("  ERROR [${tgt}] is not a TARGET")
        message("")
        return()
    endif()
