...
## After comparing at the end of summary(res), we see that these calculs
...
## H_1 { \beta_j != 0 }
##
## By looking at the summary(res), we seee the coefficients 
