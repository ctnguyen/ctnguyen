...
\rput(-5,2.3){1YR}\rput(-4,2.3){2YR}\rput(-3,2.3){3YR}\rput(-2,2.3){4YR}\rput(-1,2.3){5YR} % set horizontal label for Swaption matrix
\rput(-6.5,1){1YR}\rput(-6.5,0){2YR}\rput(-6.5,-1){3YR}\rput(-6.5,-2){4YR}\rput(-6.5,-3){5YR} % set vertibal label for Swaption matrix
...
\rput(2,2.3){$T_0$}\rput(3,2.3){$T_2$}\rput(4,2.3){$T_4$}\rput(5,2.3){$T_6$}\rput(6,2.3){$T_8$}\rput(7,2.3){$T_{10}$} % set horizon label for vol matrix
\rput(1.5,1){$s_2(t)$}\rput(1.5,0){$s_4(t)$}\rput(1.5,-1){$s_6(t)$}\rput(1.5,-2){$s_8(t)$}\rput(1.5,-3){$s_{10}(t)$}     % set vertical label for vol matrix
%%
%% set points for calibrating vol
\psset{linecolor=blue} 
%\qdisk(3,1){2pt}\qdisk(3,0){2pt}\qdisk(4,0){2pt} %
%\qdisk(3,-1){2pt}\qdisk(4,-1){2pt}\qdisk(5,-1){2pt} %
%\qdisk(3,-2){2pt}\qdisk(4,-2){2pt}\qdisk(5,-2){2pt}\qdisk(6,-2){2pt} %
