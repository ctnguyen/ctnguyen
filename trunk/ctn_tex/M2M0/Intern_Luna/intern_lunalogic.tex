...
\end{figure}
In figure \ref{fig:regularization_analysis} we se the variation error of parameters and error of quotations in relation to penalty coefficients setting.
\begin{figure}[h]
\begin{subfigure}{.5\textwidth}
  \centering
