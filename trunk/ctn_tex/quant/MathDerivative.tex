...
\begin{tabular}{l|l}
 ...
 $ dV_t = H^0_t dS^0_t + H^1_t dS^1_t     $         &  $ dV_t = r_t V_t dt + \sigma_t H^1_t S^1_t sdW^*_t  $ \\[3pt]
...
\[
\tilde{Q}_t = \frac{B^f_t}{B^d_t} Q_t = e^{(r^f -r^d)t} Q_t
\hspace{2cm}
\tilde{R}_t = \frac{B^d_t}{B^f_t} R_t = e^{(r^d -r^f)t} Q_t
\]
