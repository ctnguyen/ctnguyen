...
Heston model is a stochastic volatility model. Further than giving the dynamic of underlying asset, Heston give the dynamic of the volatility (see ~\cite{MAREK})
\[
\left\{ 
\begin{array}{rcl}
